              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select pid,ID,appdate,apptime,userStatus,doctorStatus from appointmenttb where doctor='$dname';";
        ...
        <table class="table table-hover">
                ...
                <tbody> -->
                  <?php 
                    ...
                    // $prespatdet = "select pid,fname,lname,ID,appdate,apptime,disease,allergy,prescription from prestb where doctor='$dname';";
                  ...
                  //   while ($row = mysqli_fetch_array($result)){
                  //     $ptid=$row['pid'];
                  //     $patdet1 = "select fname,lname,email,contact from patreg where pid='$ptid';";
                  //     $result4 = mysqli_query($con,$patdet1);
