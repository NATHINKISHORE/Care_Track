            ...
            <div class="card-body">
              ...
              <div class="col-md-4"><label for="doctor">Surgeries</label></div>
                ...
                <div class="col-md-4"><label for="consultancyfees">
                              ...
                              <input class="form-control" type="text" name="txtmed" id="docFees" placeholder="Medications"/>
                  </div><br><br>
                  ...
                  <br>
                  <div class="col-md-4">
                    <input type="button" name="app-submit" value="Add Medical History" class="btn btn-primary" id="inputbtn">
                  </div>
            ...
            <div class="card-body">
              ...
              <div class="col-md-4"><label for="doctor">Surgeries</label></div>
                ...
                <div class="col-md-4"><label for="consultancyfees">
                  ...
                  <div class="col-md-4"> <input type="button" name="app-submit" value="Update Medical History" class="btn btn-primary" id="inputbtn"></div>                  
                </div>
              </form>
            </div>
          </div>
